...
const BlogPostCard = ({
  ...
  return (
    <div className="flex-1 flex flex-col items-start justify-start gap-[32px] text-center text-sm text-slateblue font-text-sm-medium mq1152:flex-[unset] mq1152:self-stretch">
      <img
        className="self-stretch relative max-w-full overflow-hidden h-[252px] shrink-0 object-cover"
        alt=""
        src={image}
      />
